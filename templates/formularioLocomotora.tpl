...
<form action="{$BASE_URL}insertarOmodificarLocomotora" method="POST" style="margin-top:1%;>">
    ...
    <div class="input-group input-group-sm mb-3">
        ...
        <input type="number" class="form-control" name="anio_fabricacion" value="{$locomotora->anio_fabricacion}"
            required />

    </div>
    <div class="input-group input-group-sm mb-3">
        <span class="input-group-text">Lugar de fabricación</span>
        <input type="text" class="form-control" name="lugar_fabricacion" value="{$locomotora->lugar_fabricacion}"
            required>
    </div>
    <div class="d-grid">
        <div class="d-flex justify-content-center">

            <button class="btn   text-uppercase fw-bold btn-outline-secondary"
